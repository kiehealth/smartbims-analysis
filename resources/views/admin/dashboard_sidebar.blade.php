        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link {{ (request()->is('*admin/dashboard*')) ? 'active' : '' }}" href="{{url('/admin/dashboard')}}">
              ...
              {{ __('lang.dashboard') }} <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item border-top">
            <a class="nav-link {{ (request()->is('*admin/*report*', 'admin/*Report*')) ? 'active' : '' }}" href="{{url('/admin/reports')}}">
