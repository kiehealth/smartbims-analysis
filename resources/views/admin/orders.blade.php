    ...
    <table id="orders_table" class="table table-striped table-bordered" width="100%">
        ...
        @foreach ($orders as $order)
            <tr>
                ...
                <button class="btn btn-outline-primary" type="button" data-toggle="tooltip" title="{{ __('lang.edit-kit-information') }}">
				...
				@csrf
				@method("DELETE")
				<button class="btn btn-outline-danger" type="submit" data-toggle="tooltip" title="{{ __('lang.delete-kit-for-order') }}">
                ...
                <button class="btn btn-outline-primary" type="button" data-toggle="tooltip" title="{{ __('lang.register-kit') }}">
				...
				@csrf
				@method("DELETE")
				<button class="btn btn-outline-danger" type="submit" data-toggle="tooltip" title="{{ __('lang.delete-order') }}">
