    ...
    <table id="kits_table" class="table table-striped table-bordered" width="100%">
        ...
        @foreach ($kits as $kit)
            <tr>
                ...
                <button class="btn btn-outline-primary" type="button" data-toggle="tooltip" title="{{ __('lang.Register Sample') }}">
				...
				@csrf
				@method("DELETE")
				<button class="btn btn-outline-danger" type="submit" data-toggle="tooltip" title="{{ __('lang.delete-kit') }}">
